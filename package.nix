{ clangStdenv, cmake, cmark, curl, fetchFromGitHub, fetchpatch, fmt, fontconfig
, freetype, giflib, gitUpdater, glib, harfbuzzFull, lib, libGL, libjpeg, libpng
, libwebp, libX11, libXcursor, libXext, libXi, libXxf86vm, ninja, pcre2, pixman
, pkg-config, skia-aseprite, tinyxml-2, zlib, }:
...
clangStdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    ./laf-darwin-fix-insecure-logger.patch
    ./darwin-fix-thumbnailer-linking.patch
    ./darwin-search-in-share.patch
  ];
